...
import com.stylesphere.config.JwtUtil;
import com.stylesphere.model.User;
import com.stylesphere.model.dto.AuthRequest;
...
public class AuthController {
    ...
    public void createAuthToken(@RequestBody AuthRequest authRequest, HttpServletResponse response) throws IOException, JSONException {
        try {
